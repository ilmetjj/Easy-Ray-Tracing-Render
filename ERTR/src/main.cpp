...
//	c.point_to(vettore(0,-15,15));
	...
	sphere 
	s(4, vettore(255,255,255), 1, 0, 0, entity(vettore(0,0,15))),
	s2(2, vettore(189,50,110), 0, 1, 0, entity(vettore(5,2,15))),
	s3(1, vettore(25,148,187), 0, 1, 0, entity(vettore(7,4,17)));

	plane
	p(vettore(0,0,-1),vettore(255,255,255), 1, 0, 0, entity(vettore(0,0,100))),
	p2(vettore(0,1,0),vettore(250,230,200), 0, 1, 0, entity(vettore(0,-20,0)));

	l_point
	l(5,vettore(255,255,255),10,entity(vettore(10,10,15))),
	l1(5,vettore(255,80,0),20,entity(vettore(-50,50,0))),
	l2(5,vettore(150,255,50),30,entity(vettore(40,50,10))),
	l3(5,vettore(0,200,255),5,entity(vettore(-10,50,50)));
...
/*	camera c(25,15,75);
	...
	for(double i=5.15; i<5.4; i+=0.05){
		cout<<i<<": "<<endl;
